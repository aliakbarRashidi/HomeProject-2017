...
QString Style::getFullStyleSheet()
{
    return "QToolButton { "
           "image: url(:/buttons/full_w.png);"
           "icon-size: 12px;"
           "padding: 0px;"
           "margin: 0px;"
           "border: none;"
           "}"
           "QToolButton:hover { "
           "image: url(:/buttons/full_g.png)"
           "}"
           "QToolButton:pressed { "
           "image: url(:/buttons/full_b.png)"
           "}";
}

QString Style::getSettingsStyleSheet()
{
    return "QToolButton { "
           "image: url(:/buttons/set_w.png);"
           "icon-size: 12px;"
           "padding: 0px;"
           "margin: 0px;"
           "border: none;"
           "}"
           "QToolButton:hover { "
           "image: url(:/buttons/set_g.png)"
           "}"
           "QToolButton:pressed { "
           "image: url(:/buttons/set_b.png)"
           "}";
}
...
QString Style::getAddPushStyleSheet()
{
    return "QPushButton { "
           "image: url(:/buttons/plus-green.png);"
           "icon-size: 12px;"
...
QString Style::getBtnToolStyleSheet()
{
    return "QToolButton { "
           "background-color: #292929; "
           "padding-left: 12px;"
...
QString Style::getBtnPushToolStyleSheet()
{
    return "QPushButton { "
           "background-color: #292929; "
           "icon-size: 12px;"
...
QString Style::getSliderStyleSheet2()
{
 return
         "QSlider::groove:horizontal {"
         "border: 1px solid #454545;"
